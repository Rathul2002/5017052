...
class Inventory
{
    ...
    //Method to ADD a product details in the inventory
    ...
    //Method to Update a product details in the inventory
    ...
    //Method to Delete a product details in the inventory
    ...
    public static void main(String[] args) {
        ...
        while(true)
        {
            ...
            obj.inventory.forEach((key, value)-> value.display());*/
            if(ch==4)
                break;
        }
    }
